          ...
          >
            ...
            <li className=" nav-item">
              <a>
                ...
                <span data-i18n="nav.advance_cards.main" className="menu-title">
                  Advance Cards
                </span>
              </a>
              <ul className="menu-content">
            ...
            <li className=" nav-item">
              <a>
                ...
                <span data-i18n="nav.google_charts.main" className="menu-title">
                  google Charts
                </span>
              </a>
              <ul className="menu-content">
            ...
            <li className=" nav-item">
              <a>
                ...
                <span data-i18n="nav.color_palette.main" className="menu-title">
                  Color Palette
                </span>
              </a>
              <ul className="menu-content">
            ...
            <li className="disabled nav-item">
              <a>
                ...
                <span data-i18n="nav.disabled_menu.main" className="menu-title">
                  Disabled Menu
                </span>
              </a>
            </li>
